...
p4_table=bind_cols( transmute(A, taxon = A[,2]) ,transmute(A, fold_or_cor = ASFS_Cor_Spearman),
...
png(filename = paste0(filename,".fold_cor_sig.png"), width = 2980, height = 1580, res=300)
